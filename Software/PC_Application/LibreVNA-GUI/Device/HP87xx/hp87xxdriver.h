#ifndef HP87XXDRIVER_H
#define HP87XXDRIVER_H
...
class HP87xxDriver : public DeviceTCPDriver
{
    Q_OBJECT
public:
    HP87xxDriver();
    virtual ~HP87xxDriver();

    /**
     * @brief Returns the driver name. It must be unique across all implemented drivers and is used to identify the driver
     * @return driver name
     */
    virtual QString getDriverName() override {return "HP87xx";}
    /**
...
private:
    ...
    bool traceReaderStop(unsigned int timeout = 10000);
